const SingleMenuCardShimmer2 = () => {
  return (
    <div className='cursor-pointer h-[264px] w-[244px] relative flex-shrink-0'>
      <div className='w-full'>
        <div className='w-full h-[162.66px] object-cover rounded-2xl g:h-48 bg-gray-200 object-center' />
      </div>
...
export default SingleMenuCardShimmer2;
